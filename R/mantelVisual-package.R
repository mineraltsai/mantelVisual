##' If you use mantelVisual in published research, please cite:
##' Minglang Cai, Wenjie Hui.
...
##' Aquaculture January 2022, 551(1):737900, DOI: 10.1016/j.aquaculture.2022.737900
##'
##' @docType package
##' @name mantelVisual
